...
docker run -d --volume ./jenkins-docker/Deploy/IP_ADDRESS.env:/wordle/jenkins-docker/Deploy/IP_ADDRESS.env --volume ./jenkins-docker/Deploy/Jenkinsfile:/wordle/jenkins-docker/Deploy/Jenkinsfile --volume wordle-db:/wordle/var --name orc -p 9400:9400    --network wordle-network orc-image
