...
docker run -d --name redis -p 0.0.0.0:6379:6379 --network wordle-network -v /var/jenkins_home/workspace/wordle-github_docker-jenkins/redis.conf:./redis.conf redis:alpine redis-server /redis.conf
